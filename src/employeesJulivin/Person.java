...
public class Person implements Serializable {
	...
	public Person(int id, String name, BigDecimal timeAtWork,BigDecimal sdf, int absences,BigDecimal totalTimeToWork, String dayOff,Instant start,Instant end,ArrayList<String> arriveLeave) {
